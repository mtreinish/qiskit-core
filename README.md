...
Qiskit offers two public APIs Python API and C API. The Python API is the primary user interface and prior to Qiskit 2.0.0 was the only public API available
