...
class Optimize2qBlocks(TransformationPass):
    ...
    def run(self, dag):
        ...
        all_block_gates = set()
        blocks_as_unitaries = []
        if self._unitary_synthesis_method is not None and self._unitary_synthesis_method != "default":
            ...
            synth_pass = UnitarySynthesis(
                ...
                method=self.unitary_synthesis_method,
                plugin_config=self.unitary_synthesis_config,
            )
