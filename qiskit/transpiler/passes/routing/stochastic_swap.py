...
class StochasticSwap(TransformationPass):
    ...
    def _layer_permutation(self, layer_partition, layout, qubit_subset, coupling, trials):
        ...
        best_edges, best_layout, best_depth = stochastic_swap_rs.swap_trials(trials, num_qubits, len(gates), int_layout, int_qubit_subset, int_gates, cdist, cdist2, edges, self.seed)
        ...
        for idx in range(len(best_edges.edges()) // 2):
