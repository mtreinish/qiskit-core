...
impl TwoQubitWeylDecomposition {
    ...
    fn new(
        ...
        build_two_qubit_weyl_decomposition(unitary_matrix.as_array(), fidelity, _specialization)
    }
...
impl TwoQubitBasisDecomposer {
    ...
    pub fn synthesize(
        ...
        let target_decomposed =
            build_two_qubit_weyl_decomposition(unitary, Some(DEFAULT_FIDELITY), None)?;
...
impl TwoQubitBasisDecomposer {
    ...
    #[new]
    #[pyo3(signature=(gate, gate_obj, gate_matrix, basis_fidelity=1.0, euler_basis="U", pulse_optimize=None))]
    fn new(
        gate: String,
        gate_obj: PyObject,
